...
from main.service_section.Serviceorder.models import ServiceOrder
from main.service_section.Serviceproduct.models import ServiceProduct
from main.service_section.Subject.models import Subject
from main.service_section.Serviceorder.serializers import ServiceOrderCreateSerializer
    ...
    try:
        response = requests.post(
            ...
            json={
                ...
                "callback_url": f"https://juikeexams.onrender.com/servicesuccess/{order.reference}/",
                "metadata": {
